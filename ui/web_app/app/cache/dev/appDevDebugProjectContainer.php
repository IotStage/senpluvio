...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'senpluvio_webapp', 'user' => 'abdoulaye', 'password' => 'kamstelecom', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/AWS/MonitoringBundle/Entity'))), 'AWS\\MonitoringBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AWSMonitoringBundle' => 'AWS\\MonitoringBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_21cf561f6d138bcee9ced6650caa3852ccd608997cb247c5158161102eca3480');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Administration/AdminBundle/Resources/views'), 'AdministrationAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/AWS/ExploitationBundle/Resources/views'), 'AWSExploitation');
        $instance->addPath(($this->targetDirs[3].'/src/AWS/MonitoringBundle/Resources/views'), 'AWSMonitoring');
        $instance->addPath(($this->targetDirs[3].'/src/API/RestBundle/Resources/views'), 'APIRest');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dd1df3e44d814f8dc8bcc8aaea8a5d1249757e15');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('593039ed5e5641.45838463')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdministrationAdminBundle' => 'Administration\\AdminBundle\\AdministrationAdminBundle',
                'AWSExploitationBundle' => 'AWS\\ExploitationBundle\\AWSExploitationBundle',
                'AWSMonitoringBundle' => 'AWS\\MonitoringBundle\\AWSMonitoringBundle',
                'APIRestBundle' => 'API\\RestBundle\\APIRestBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'AdministrationAdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Administration/AdminBundle'),
                    'namespace' => 'Administration\\AdminBundle',
                ),
                'AWSExploitationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AWS/ExploitationBundle'),
                    'namespace' => 'AWS\\ExploitationBundle',
                ),
                'AWSMonitoringBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AWS/MonitoringBundle'),
                    'namespace' => 'AWS\\MonitoringBundle',
                ),
                'APIRestBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/API/RestBundle'),
                    'namespace' => 'API\\RestBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => NULL,
            'database_name' => 'senpluvio_webapp',
            ...
            'secret' => 'dd1df3e44d814f8dc8bcc8aaea8a5d1249757e15',
            'locale' => 'en',
            ...
            'kernel.secret' => 'dd1df3e44d814f8dc8bcc8aaea8a5d1249757e15',
